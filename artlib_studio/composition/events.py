...
class CompositionEventType(str, Enum):
    ...
    MODULATION_SENT = "MODULATION_SENT"
    MODULATION_RECEIVED = "MODULATION_RECEIVED"
    MODULE_PARAMETER_MODULATED = "MODULE_PARAMETER_MODULATED"
    MODULE_PARAMETER_RESTORED = "MODULE_PARAMETER_RESTORED"
